...
plugin-specific attribute types: url (Resource), Namespace and Bucket (Allocation).
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Plugin-only ResourceAttributeType: url (Text from add_resource_defaults)
        ...
        self.stdout.write("  ResourceAttributeType: url" + (" (created)" if created else " (exists)"))
